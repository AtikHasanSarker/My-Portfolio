const educationData = [
    ...
    },
    {
        ...
        description:
            "Currently pursuing Complete Web Development from Jhankar Mahbub's Programming Hero. Focusing on problem solving, modern web technologies. Learning full-stack development including frontend, backend development.javascript, react, nodejs, expressjs, mongodb,etc.",
    },
];
                            ...
                            <div key={index} className="relative pl-16">
                                ...
                                <div className="absolute left-0 top-5">
                                    <div className="relative flex items-center justify-center">
                                        ...
                                        {/* Glow */}
                                        <div className="absolute w-5 h-5 rounded-full bg-violet-500 blur-md opacity-60"></div>
                                    </div>
                                </div>

                                {/* Card */}
                                <div className="rounded-[28px] border border-white/10 bg-white/[0.04] backdrop-blur-md p-10 transition-all duration-300 hover:border-violet-500/30 hover:bg-white/[0.06]">
